      ...
      <div className="page-content">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            At ninexagro, we&apos;re on a mission to revolutionize agriculture in India. Join our team of 
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Why Work at ninexagro?</h2>
