  ...
  const testimonials = [
    {
      name: "Rajesh Kumar",
      role: "Farmer, Punjab",
      content: "ninexagro has transformed how I purchase agricultural inputs. The quality of products and timely delivery has helped improve my farm's productivity significantly."
    },
    {
      name: "Priya Sharma",
    ...
    },
    {
      ...
      content: "I recommend ninexagro to all my clients. Their competitive prices and genuine products make them the best choice for agricultural supplies."
    }
  ];
      ...
      <div className="page-content">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            ninexagro is committed to empowering farmers and agricultural professionals with quality products, 
        ...
        <div className="cta-banner">
          <h3>Ready to Experience the ninexagro Difference?</h3>
