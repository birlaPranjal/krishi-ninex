        ...
        <div className="policy-content">
          ...
          <div className="info-box mb-8">
            <p className="text-gray-700">
              Welcome to ninexagro. By accessing or using our website and services, you agree to be bound 
          ...
          <p>
            By accessing, browsing, or using the ninexagro website (www.eclatagro.com) or any of our mobile 
          ...
          <p>
            ...
            audio clips, digital downloads, and software, is the property of ninexagro or its content 
          ...
          <div className="info-box info-box-yellow mb-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">
                ninexagro shall not be liable for any indirect, incidental, special, consequential, or 
          ...
          <p>
            You agree to indemnify and hold harmless ninexagro, its officers, directors, employees, and 
