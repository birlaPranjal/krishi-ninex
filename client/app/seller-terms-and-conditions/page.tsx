    ...
    <div className="min-h-screen w-screen overflow-x-hidden bg-white">
      ...
      <div className="hero-banner">
        <div className="hero-banner-content">
          ...
          <p>Guidelines for Selling on ninexagro Platform</p>
        </div>
      </div>
      ...
      <div className="page-content">
        ...
        <div className="policy-content">
          ...
          <div className="info-box mb-8">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">
                These Seller Terms and Conditions govern your use of the ninexagro platform as a seller. 
          ...
          <p>To become a seller on ninexagro, you must:</p>
          <ul>
          ...
          <ul>
            ...
            <li>ninexagro charges a commission on each successful sale (5-10% based on category)</li>
          ...
          <ul>
            ...
            <li>Handle returns and refunds as per ninexagro&apos;s policies</li>
          </ul>
          ...
          <ul>
            ...
            <li>Cooperate with ninexagro&apos;s customer service team</li>
          ...
          <ul>
            ...
            <li>Directly solicit customers outside ninexagro</li>
          ...
          <ul>
            ...
            <li>ninexagro is not liable for seller-customer disputes</li>
            <li>Sellers must maintain appropriate business insurance</li>
            <li>Sellers indemnify ninexagro against any claims arising from their products</li>
          </ul>

          <h2>11. Modifications</h2>
          <p>
            ninexagro may modify these terms with prior notice. Continued use of the platform 
          ...
          <div className="cta-banner mt-8">
            ...
            <p>Join thousands of sellers on ninexagro and grow your business!</p>
