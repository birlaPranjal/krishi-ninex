...
const products = [
  ...
  },
  {
    ...
    brand: 'ninexagro Trade Link Private Limited',
    rating: 4.49,
    reviews: 242,
    originalPrice: 3740,
    currentPrice: 1244,
    ...
    <section className="py-4 md:py-5 lg:py-6 bg-white">
      <div className="container mx-auto px-2 md:px-3 max-w-[1400px]">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900">Best Sellers</h2>
          <a href="#" className="text-[#16a34a] hover:text-[#15803d] font-semibold text-sm md:text-base transition-colors whitespace-nowrap hover:underline">
            View All →
          </a>
        </div>
