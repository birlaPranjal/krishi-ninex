      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-200 hover-lift flex flex-col h-full">
        ...
        <div className="relative aspect-square bg-gray-50 flex-shrink-0">
          <Image
            ...
            fill
            className="object-contain p-0.5 sm:p-1 md:p-1.5 lg:p-2"
          ...
          {product.discountPercent > 0 && (
            <div className="absolute top-1.5 sm:top-2 left-1.5 sm:left-2 z-10">
              <span className="bg-red-600 text-white text-[8px] sm:text-[9px] md:text-[10px] font-bold px-1 sm:px-1.5 py-0.5 rounded shadow-sm">
          ...
          >
            <Heart size={12} className="sm:w-3.5 sm:h-3.5 text-gray-500 group-hover:text-red-500 transition-colors" />
          </button>
        </div>
        ...
        <div className="p-2 sm:p-2.5 md:p-3 flex-1 flex flex-col">
          ...
          <h3 className="text-[10px] sm:text-[11px] md:text-xs font-semibold text-gray-900 mb-1 sm:mb-1.5 line-clamp-2 min-h-[2rem] leading-tight">
            {product.name}
          </h3>

          {/* Brand - Better visibility */}
          {product.brand && (
            <p className="text-[8px] sm:text-[9px] text-gray-600 mb-1 sm:mb-1.5 line-clamp-1 font-medium">
              {product.brand}
            </p>
          )}
          ...
          {product.rating !== null && product.reviews !== null && (
            <div className="flex items-center gap-0.5 mb-1 sm:mb-1.5">
              <div className="flex items-center">
                ...
                <span className="text-[9px] sm:text-[10px] text-gray-700 ml-0.5 font-semibold">{product.rating}</span>
              </div>
          ...
          {/* Quantity - Clear display */}
            <p className="text-[8px] sm:text-[9px] text-gray-600 mb-1.5 sm:mb-2 line-clamp-1 font-medium">
          ...
          <button
            ...
            className="w-full bg-[#16a34a] hover:bg-[#15803d] disabled:bg-gray-400 disabled:cursor-not-allowed text-white text-[9px] sm:text-[10px] font-semibold py-1 sm:py-1.5 md:py-2 rounded-md transition-all duration-200 mt-auto flex items-center justify-center shadow-sm hover:shadow-md"
          >
